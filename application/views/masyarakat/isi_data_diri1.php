          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Form Identitas Diri : <?= $this->session->userdata('username') ?></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="box-body">
                    <div class="alert alert-warning alert-dismissible">
                      ...
                      <h5 style= "text-align: center;"><i> Dalam pengisian data. Isilah data dengan benar, jika tidak ada cukup di isi dengan " - ".</i></h5>
                    </div>
                  <div class="x_content">
                    <br />
