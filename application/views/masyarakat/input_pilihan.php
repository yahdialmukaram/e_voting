				...
				<div class="x_panel">
					...
					<div class="x_content">
						<div id="" class="alert alert-warning alert-dismissible">
							...
							<marquee>
								<h4>Masukan Sura Anda, Anda hanya dapat memilh satu kali. Terimkasih atas partisipasinya
								</h4>
							</marquee>
						</div>
					</div>
					...
					<table id="datatable" class="table table-striped table-bordered">
                        ...
                        foreach ($paslon as $key => $value):?>
							<tr>
								...
								<td style="text-align: center;"><?=$value['nama_paslon'];?>
									<hr><img style="width: 200px;height: 200px;  "
										src="<?=base_url();?>uploads/original_image/<?=$value['image_paslon'];?>">

								</td>
								<td style="text-align: center;"><?=$value['nama_wakil'];?>
									<hr><img style="width: 200px;height: 200px;  "
								...
								<td>
									...
									<br>
									<br>
									<a href="#" onclick="visi(<?=$value['id_paslon']?>);"> <i
											class="btn btn-danger fa fa-book"> Visi Misi</i> </a>
									<br>
									<br>
									<?php if ($status == false):?>
									<a href="#" onclick="verifikasi();"> <i class="btn btn-primary fa fa-check-circle">
											Pilih</i> </a>
									<?php else: ?>
									<?php if ($suara==null):?>
									<a href="#" onclick="input_pilihan(<?=$value['id_paslon']?>);"> <i
											class="btn btn-primary fa fa-edit"> Pilih</i> </a>
									<?php endif;?>
									<?php endif;?>
								</td>
							</tr>
...
<div class="modal fade" id="verifikasi" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<i class="btn btn-danger">Maaf data anda berlum terverfikasi, jadi anda tidak bisa memilih, mohon tunggu
					verifikasi
			</div></i>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
