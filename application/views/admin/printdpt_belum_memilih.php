...
<body>
	...
	<img src="uploads/original_image/lambang.png" style="float:left; width: 90px; height: 90px;">
	<h3 style="text-align: center;"><u>DATA PEMILIH TETAP (DPT) BELUM MEMILIH KECAMATAN BATIPUH SELATAN</u>
		<br><br><u>KABUPATEN TANAH DATAR</u></h3>
		...
		<tbody>
			<tr>
				...
				<td>
					...
					<a href="#" class="label label-danger"><i class="fa fa-ban"></i> Belum Memilih</a>
					<?php endif; ?>
				</td>
				<td><?=$value['no_hp'];?></td>
				<td><?=$value['agama'];?></td>
