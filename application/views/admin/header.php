        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>E-Voting</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?=base_url();?>controller/data_pemilih/"><i class="fa fa-book"></i> Data DPT</a>
                  <li><a href="<?=base_url();?>controller/data_selesai_memilih"><i class="fa fa-check"></i> Data DPT Sudah Memilih</a>
                  <li><a href="<?=base_url();?>controller/data_belum_memilih"><i class="fa fa-spinner"></i> Data DPT Belum Memilih</a>
